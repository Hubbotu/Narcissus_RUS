...
L["Toolbar HideTexts Button Tooltip"] = "Скрыть все имена, чаты и тексты боя." ..L["Восстановить при выходе"];

L["Toolbar TopQuality Button"] = "Высшее качество";
L["Toolbar TopQuality Button Tooltip"] = "Установите все параметры в настройках графики на максимум." ..L["Восстановить при выходе"];
