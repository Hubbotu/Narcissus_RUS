...
NARCI_DEVELOPER_INFO = "Разработчик Peterodox";
...
NARCI_MODIFIER_ALT = "Клавиша Alt";   --Windows
NARCI_SHORTCUTS_COPY = "Ctrl+C";
if IsMacClient() then
      --Mac OS
    NARCI_MODIFIER_ALT = "Ключевой параметр";
...
L["Q4"] = "Хорошо. Что если я хочу отключить это?";
L["Q5"] = "И еще одно, не могли бы вы пообещать мне больше никаких шалостей?";
L["A1"] = "По-видимому, это диалог подтверждения выхода. Он появляется при попытке выйти из режима групповой фотографии нажатием горячей клавиши.";
L["A2"] = "Ха, вот что она сказала.";
L["A3"] = "Хорошо...хорошо..."
L["A4"] = "Просто откройте Настройки, а затем перейдите в режим фото. Вы не пропустите это.";