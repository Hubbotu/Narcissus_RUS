...
L["Splash Content2 Name"] = "Вкладка Анимация";
L["Splash Content2 Description"] = "-Вы можете искать и любимые анимации.\n-У некоторых анимаций есть вариации, теперь их тоже можно выбрать.";
...
L["Splash Content5 Description"] = "-Отдельная рамка достижений.\n-Легко перемещаться вперед и назад при просмотре связанных достижений.\n-Создайте карточку, просто перетащив запись.\n-Более плавный, менее заикающийся.";
L["Splash Category4"] = "Разнообразное";
...
L["Splash Content7 Name"] = "Высшее качество";
...
L["Flavored Text"] = "Посетите любой Йогг Салон в крупных городах сегодня и получите 10‰ скидку.";
